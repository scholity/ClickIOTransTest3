...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <consoleConfig>
        ...
        <liveAgentConfig>
            ...
            <openNewVFPageSubtab>true</openNewVFPageSubtab>
            <pageNamesToOpen>CTIScreenPop</pageNamesToOpen>
            <showKnowledgeArticles>false</showKnowledgeArticles>
        </liveAgentConfig>
        <whitelistedDomains>www.saba.com</whitelistedDomains>
        <whitelistedDomains>
classes.redcross.org</whitelistedDomains>
        <whitelistedDomains>
www.instructorscorner.org</whitelistedDomains>
        <whitelistedDomains>
webi.redcross.org</whitelistedDomains>
        <whitelistedDomains>
iris.teletech.com</whitelistedDomains>
        <whitelistedDomains>
c.cs11.visual.force.com</whitelistedDomains>
        <whitelistedDomains>
www.shopstaywell.com</whitelistedDomains>
        <whitelistedDomains>
www.redcross.org</whitelistedDomains>
        <whitelistedDomains>
rc.shopstaywell.com</whitelistedDomains>
    </consoleConfig>
    <defaultLandingTab>standard-home</defaultLandingTab>
    <description>Used by the Training Support Center to manage cases via phone, email and chat.</description>
    <isNavAutoTempTabsDisabled>false</isNavAutoTempTabsDisabled>
    <isNavPersonalizationDisabled>false</isNavPersonalizationDisabled>
    <isServiceCloudConsole>true</isServiceCloudConsole>
    <label>TSC Agent Console</label>
    <preferences>
    ...
    <tabs>Chat_Supervisor_Console</tabs>
