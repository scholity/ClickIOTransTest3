...
[Postmaster] Email Delivery Failure</description>
    ...
    <fieldUpdates>
        <fullName>Update_RDC_Queue_Checkbox</fullName>
        <field>Assigned_To_RDC_Queue__c</field>
        <literalValue>1</literalValue>
        <name>Update RDC Queue Checkbox</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
...
ISPICKVAL( Billing_Web_Request_Type__c ,&quot;Complete Vendor Forms&quot;),
ISPICKVAL( Billing_Web_Request_Type__c ,&quot;Payment Applied To Wrong Invoice/Account&quot;)
), 
CreatedBy.FirstName = &quot;BillingRequestForm&quot;, 
ISPICKVAL(Origin, &quot;Web to Case&quot;), 
$Setup.Workflow_Rules__c.Bypass_Rules__c = False )</formula>
...
ISPICKVAL(Status, &quot;On Hold - IRT&quot;), 
ISPICKVAL(Status, &quot;On Hold - Customer&quot;), 
ISPICKVAL(Status, &quot;Follow Up - New Email&quot;), 
ISPICKVAL(Status, &quot;Agent Follow Up&quot;), 
ISPICKVAL(Status, &quot;On Hold - Sales&quot;), 
ISPICKVAL(Status, &quot;On Hold - Sales Admin&quot;), 
ISPICKVAL(Status, &quot;On Hold - Data Integrity&quot;), 
ISPICKVAL(Status, &quot;On Hold - Sales Rep&quot;)), 
$Setup.Validation_Rules__c.Bypass_Rules__c =False)</formula>
 ...
 $Setup.Workflow_Rules__c.Bypass_Rules__c =false)</formula>
    ...
    <rules>
        ...
        <criteriaItems>
            ...
            <value>Community Course Cancellation</value>
        </criteriaItems>
...
$Setup.Workflow_Rules__c.Bypass_Rules__c = false 
    ...
    <rules>
        <fullName>RDC Queue Assignment Check</fullName>
        <actions>
            <name>Update_RDC_Queue_Checkbox</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        ...
        <description>Wflow sends an email to contact with a link to a web survey. Wflow checks if contact on case has been sent a survey within the last X amount of hours.</description>
        <formula>AND ( 
OR(RecordTypeId = &quot;012d000000097TD&quot;, 
RecordTypeId = &quot;012d000000097TC&quot;,
RecordTypeId = &quot;0120V000001pNvg&quot;,
RecordTypeId = &quot;012d0000001cm4l&quot;),
 ...
 Contact.HasOptedOutOfEmail = false, $Setup.Workflow_Rules__c.Bypass_Rules__c = false )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
...
ISPICKVAL( Type,&quot;Invoicing&quot;),
 ...
 $Setup.Workflow_Rules__c.Bypass_Rules__c = false  
    ...
    <rules>
        ...
        <active>true</active>
        <description>This workflow will update the Service case record type to read only.</description>
        <formula>AND(  RecordType.Name = &apos;Service Cases&apos;,  IsClosed = TRUE,  $Setup.Workflow_Rules__c.Bypass_Rules__c = FALSE ,  !ISPICKVAL(Status,&apos;Closed - Invoicing&apos;))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
...
$Setup.Workflow_Rules__c.Bypass_Rules__c = FALSE  )</formula>
    ...
    <rules>
        <fullName>Update  RCS PO Case Owner</fullName>
        <actions>
            <name>Update_Case_owner_to_RCS_PO</name>
            <type>FieldUpdate</type>
        </actions>
        ...
        <criteriaItems>
            ...
            <operation>equals</operation>
            <value>rcspo@redcross.org</value>
        </criteriaItems>
        <description>Changes the case owner to RCS PO</description>
        <triggerType>onCreateOnly</triggerType>
    </rules>
...
Change_Invoice_New_Status__c = FALSE</formula>
    ...
    <rules>
        ...
        <description>Automatic email associated with RCSPO Case customers that are included in the daily customer account file of RCSPO accounts that are transferred from Salesforce to CFS and DWRE</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
